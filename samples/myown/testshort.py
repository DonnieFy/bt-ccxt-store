...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        for d in self.datas:
            self.inds[d] = dict()
            self.inds[d]['high_15'] = bt.indicators.Highest(d.close, period=1)
            self.inds[d]['high_30'] = bt.indicators.Highest(d.close, period=2)
            self.inds[d]['high_45'] = bt.indicators.Highest(d.close, period=3)
            self.inds[d]['high_60'] = bt.indicators.Highest(d.close, period=4)
