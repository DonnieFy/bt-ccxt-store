...
; (async () => {
    ...
    while (true) {
        ...
        try {
            ...
            logger.log('%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d', num++, amount, buySum, sellSum, buySpread, sellSpread, spreadSum, maxPrice, minPrice, layeringBidPrice, layeringBidAmount, layeringAskPrice, layeringAskAmount, imbalance, bid1, ask1, position);
